...
square = create_latin_square(6, 4)
...
for p in range(len(cond_matrix)):
    ...
    for i in range(len(cond_matrix[p])):
        ...
        startPos1 = randint(0, NUM_OF_CIRCS)
        startPos2 = randint(0, NUM_OF_CIRCS)
        ...
        tl.append({"stage" : "baseline", 
            ...
            "for": [baselineOrd[0], baselineOrd[1]],
            "block": "2",
            "startPos": (startPos2 + 1) % NUM_OF_CIRCS})
        tl.append({"stage" : "instruction", "conds": [baselineOrd[0], baselineOrd[0]]})
        tl.append({"stage" : "baseline", 
            "conds": [baselineOrd[0], baselineOrd[0]],
            "for": [baselineOrd[0], baselineOrd[1]],
            "block": "2",
            "startPos": (startPos1 + 1) % NUM_OF_CIRCS})
...
timelines['foldtest1'] = timelines[1]
timelines['foldtest2'] = timelines[2]
timelines['foldtest3'] = timelines[3]
timelines['foldtest4'] = timelines[4]
