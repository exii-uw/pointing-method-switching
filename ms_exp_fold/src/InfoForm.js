...
function DefaultText() {
  return (
    <div style={{ fontSize: 'larger' }}>
      ...
      <p>
        &emsp;Pen & Touch - <b>Block 1</b>; Pen & Touch - <b>Block 2</b>; Pen &
        Touch - <b>Block 3</b>; Pen & Touch - <b>Block 4</b>;
      </p>
      <p>
        &emsp;Touch Baseline - <b>Block 2</b>; Pen Baseline - <b>Block 2</b>;
      </p>
      <p></p>
      <p>
      ...
      <hr />
      <h3>Experiment Devices:</h3>
      <p></p>
      Before beginning the experiment, please place the laptop on the wooden
      stand, in the same way as the below picture:
      <p></p>
      <img
        src={process.env.PUBLIC_URL + '/laptopstand.jpg'}
        width="400px"
        alt="Not connected mouse on ipadOS."
      />
      <p></p>
      Also, please arrange the devices in the same way as the
      below picture:
      <p></p>
      <img
        src={process.env.PUBLIC_URL + '/laptop_layout.jpeg'}
        width="400px"
        alt="Not connected mouse on ipadOS."
      />
      <p></p>
